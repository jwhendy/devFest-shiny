...
\end{itemize}
\end{frame}
\begin{frame}[label=sec-18]{Table of possible outcomes}
\begin{center}
\tiny
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[fragile,label=sec-19]{Check against criteria; convert to binary}
 \scriptsize
\begin{verbatim}
...
\normalsize
\end{frame}
\begin{frame}[fragile,label=sec-20]{Hacky function lookup}
 \tiny
\begin{verbatim}
map_funcs <- list(
